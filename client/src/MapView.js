                    ...
                    >
                        <Popup>
                            <div style={{ fontFamily: 'Arial, sans-serif' }}>
                                <h4 style={{ margin: '0 0 8px 0', color: '#1f2937' }}>🚂 {train.id}</h4>
                                <p style={{ margin: '4px 0' }}><strong>Type:</strong> {train.type}</p>
                                <p style={{ margin: '4px 0' }}><strong>Direction:</strong> {Math.round(train.bearing)}°</p>
                                <p style={{ margin: '4px 0' }}><strong>Track:</strong> {train.track?.properties?.name || 'Unknown'}</p>
                                <p style={{ margin: '4px 0' }}><strong>Distance to Track:</strong> {Math.round(train.metadata?.distanceToTrack || 0)}m</p>
                            </div>
                        </Popup>
                    </Polyline>
                ))}
